...
grep -Fq 'helm upgrade --install traefik ./chart.tgz --namespace kubemate-system --create-namespace --wait --timeout 10m --set image.tag=v1' "${TEST_ROOT}/calls" || fail "Helm 参数顺序错误"
